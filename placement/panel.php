				...
				<div class="panel">
					...
					<div class="panel-content">
						<!--<form action="login.php" method="post">
						  ...
						  <p id="rmessage"><label for='registr'>Kindly fill-in the form to start the process to recruit students for summer internships
and full time role at IIT Patna in academic year 2022-23.</label><a href="https://forms.gle/FdDpWF3dgKx9iQLB6" target="_blank"><button id='registr' class='btn-reg'><div class="blink_me">REGISTER</div></button></a></p>
