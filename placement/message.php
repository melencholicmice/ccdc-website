		...
		<div class="grid-80">
			<div class="grid-block">	
				<div class="index-intro-text" style="direction:ltr">
					<h1>Director's Message</h1><br>

					<div >
					<p>
					<img src="https://www.iitp.ac.in/images/photo/tns.jpg" width="40%" style="float:right;margin:10px;">
...
Patna has been a center of knowledge and a land of visionaries since long and has been attracting visitors and scholars from many parts of the world. Some of the legends from this region include Lord Gautam Buddha, Lord Mahavir, Guru Gobind Singh, the famous astronomer Aryabhatta, and the first President of India, Dr. Rajendra Prasad. IIT Patna strives to carry the baton passed through these visionaries to become a beacon of knowledge and wisdom.</p><p>
