		...
		<div class="grid-con-1" style="height:auto;">
			<div class="grid-block">	
				<div class="index-intro-text" style="direction:ltr">
					<h1 style="font-size: 28px;">Message from Faculty In Charge</h1><br>

					<div>
						<p style="text-align:justify">
						<img src="images/fac/pic.jpeg" style="float:right;margin:10px;width:320px;padding: 10px 10px 10px 10px; border-radius: 50%;">
						...
						Yours sincerely,<br> -->
						Dr. Ashwani Assam,<br>
						Professor In charge, Centre for Career Development, <br>
						IIT Patna. 
						</p>
					</div>
				</div>
